...
class TestPlacementsGeneratorPlacementOutput(unittest.TestCase):
    """
    Test that the placements generator generates placements properly
    """
    ...
    def setUp(self):
        ...
        self.gen = PlacementsGenerator(self.patientgen, [-1])
    ...
    def test_activity_data_model_field(self):
        ...
        self.assertEqual(field.text, 'nh.clinical.patient.placement',
    ...
    def test_suggested_location_id_field(self):
        """
        Make sure the suggested_location_id field for the  is correct
        """
        field = \
            self.model_record.find('field[@name=\'suggested_location_id\']')
        self.assertEqual(field.attrib['ref'], 'nhc_def_conf_location_wa',
                         'Incorrect suggested_location_id on activity')
