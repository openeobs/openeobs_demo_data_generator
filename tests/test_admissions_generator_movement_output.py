...
class TestAdmissionsGeneratorMovementOutput(unittest.TestCase):
    """
    ...
    def setUp(self):
        ...
        self.activity_update_record = records[8]
    ...
    def test_activity_record(self):
        ...
        self.assertEqual(self.activity_record.attrib['id'],
                         'nhc_activity_demo_admit_move_0',
                         'Incorrect ID ')
    ...
    def test_activity_id_field(self):
        ...
        self.assertEqual(field.attrib['ref'], 'nhc_activity_demo_admit_move_0',
